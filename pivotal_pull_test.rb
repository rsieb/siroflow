...
@myprojects.each do |projectnummer|
  ...
  @thisprojectstories = @a_project.stories.all(:type => 'release').find_all{|rel| rel.deadline < @mydeadline}
  @mystories = @mystories + @thisprojectstories
end
...
#       mijnstatus = "ztarted" # come on top in reverse sortirb
#     end
#   rescue
