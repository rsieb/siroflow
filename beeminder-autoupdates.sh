...
/Users/rs/.rbenv/shims/beemind -t  UUTnFgjX2FyEyC3GX2zW jdays `ruby jira_avgdayssincemod.rb` "Auto-added `date` from launchagents /beeminder-autoupdates.sh"
/Users/rs/.rbenv/shims/beemind -t  UUTnFgjX2FyEyC3GX2zW deo `ruby -e "puts (Time.now - Time.new(2015,4,16))/86400"` "Auto-added `date` from launchagents /beeminder-autoupdates.sh"
