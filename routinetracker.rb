...
module RoutineTracker
  ...
  while true == true # endless loop until interrupted
    ...
    if mytask.start_with?("aah")
      @terminal.ask("Describe your task and the project it fits under?","> ")
    end
    ...
    @tasks.each do |taak|
      ...
      taak.each do |naam,waarden|
        ...
        while @gedaan == nil
          ...
          @terminal.notify "#{starttijd.strftime("%H:%M:%S")} Projecting routine finish by #{endtime.strftime("%H:%M:%S")}\n"
